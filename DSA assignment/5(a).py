...
class AntColony:
    def __init__(self, distances, num_ants, num_iterations, decay_factor, alpha, beta):
        ...
        self.pheromone_levels = [[1.0 / (self.num_cities * self.num_cities) for _ in range(self.num_cities)] for _ in range(self.num_cities)]
        self.best_path = []
        self.best_distance = float('inf')
        self.initialize_pheromones()

    def initialize_pheromones(self):
        pass  # Initialization is done during object creation in Python
